...
const names = [
  "activity", "archive", "arrow-down", "arrow-right", "arrow-up", "arrow-up-right", "book-open", "bot", "boxes",
  "brain", "brush", "camera", "check", "chevron-down", "chevron-right", "circle-alert", "circle-check",
  "circle-dot", "circle-pause", "circle-play", "circle-stop", "clipboard-list", "cloud-download", "cloud-upload",
  "command", "compass", "copy", "corner-down-left", "cpu", "database", "diamond", "download", "external-link",
  ...
  "key-round", "layers", "layout-dashboard", "lightbulb", "link", "list", "loader-circle", "lock",
  ...
  "triangle-alert", "type", "unplug", "upload", "user-minus", "user-round", "users", "wallet", "waves",
